...
function InvestEventCard({ icon, backgroundColor, topAccesary, title, titleColor, content, contentColor }: Props) {
  return (
    <div className={style.container} style={{ backgroundColor }}>
      ...
      <div className={style['content-wrapper']}>
        ...
        <Text typography="t900" className={style.title} color={titleColor}>
          {title}
        </Text>
